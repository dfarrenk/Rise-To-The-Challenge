...
INSERT INTO `challenge`.`Instances` (`challenge_id`, `challenger_proof`, `challenged_proof`, `state`, `createdAt`, `updatedAt`, `issuer_id`, `accepter_id`, `template_id`) VALUES (NULL, 'www.placehold2.com', NULL, 'proof-accepted', '', '', '2', '1', '1');

INSERT INTO `challenge`.`Instances` (`challenge_id`, `challenger_proof`, `challenged_proof`, `state`, `createdAt`, `updatedAt`, `issuer_id`, `accepter_id`, `template_id`) VALUES (NULL, 'www.whocared.com', 'www.Icared.com', 'provided-proof', '', '', '2', '1', '1');
